...
public class RockApp {
    ...
    private static final Logger log = LoggerFactory.getLogger(RockApp.class);

    private final Environment env;

    public RockApp(Environment env) {
        this.env = env;
    }
    ...
    public static void main(String[] args) throws UnknownHostException {
        SpringApplication app = new SpringApplication(RockApp.class);
